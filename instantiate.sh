...
# swap placeholders
rg 'jpillora' --files-with-matches . | xargs sed -i 's/jpillora/jpillora/g'
rg 'go-template-demo' --files-with-matches . | xargs sed -i 's/go-template-demo/go-template-demo/g'
